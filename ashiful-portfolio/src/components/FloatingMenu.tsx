  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-5 right-4 z-50 grid h-12 w-12 place-items-center rounded-xl border border-[#3c3c3c] bg-[#252526]/95 shadow-lg shadow-black/30 backdrop-blur transition hover:border-[#007acc]/60 hover:bg-[#2d2d30] md:hidden sm:bottom-8 sm:right-8"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-40">
          ...
          <div className="absolute bottom-20 right-4 w-[calc(100%-2rem)] max-w-sm overflow-hidden rounded-xl border border-[#3c3c3c] bg-[#1e1e1e] shadow-2xl shadow-black/50 sm:bottom-28 sm:right-8">
