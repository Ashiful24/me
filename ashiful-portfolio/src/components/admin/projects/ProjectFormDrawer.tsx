        ...
        >
          <div className="flex-1 space-y-4 overflow-y-auto p-4">
            ...
            <label className="block text-sm">
              <span className="mb-1 block text-[#858585]">File name *</span>
              <input
                value={form.file}
            ...
            <label className="block text-sm">
              <span className="mb-1 flex items-center justify-between text-[#858585]">
            ...
            <label className="block text-sm">
              <span className="mb-1 block text-[#858585]">GitHub URL</span>
              <input
                value={form.github}
            ...
            <label className="block text-sm">
              <span className="mb-1 block text-[#858585]">Live URL</span>
              <input
                value={form.live}
